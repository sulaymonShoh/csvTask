...
class GetRange:
    def __init__(self):
        ...
        self.labelMain = tk.Label(self.window, text='Son oralig\'ini kiriting:', font=('Arial', 17))
        self.labelMain.pack()
    ...
    def closeRange(self):
        ...
        b = self.entryB.get()
        if a=='' or b=='':
            messagebox.showerror("Xatolik", "Sonlarni kiritishda xatolik")
        elif a >= b:
...
class GetTime:
    ...
    def closeTime(self):
        ...
        if int(usertime) < 1:
            messagebox.showerror("Xatolik", "Minimum vaqt 1 sekund!")
